...
<body>
    ...
    <section id="pricing-part" class="pt-200">
        {{-- <div class="container"> --}}
        <div class="m-3">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="singel-pricing gray-bg text-center mt-30">
                        <h4>Standard</h4>
                        <h3><i class="fa fa-usd"></i>40<span>/Weekly</span></h3>
                        <ul>
                            <li>20 Big Bottols</li>
                            <li>10 Mini Bottols</li>
                            <li>Posted For 01 Days</li>
                            <li>Service $80</li>
                        </ul>
                        <a href="#">DISINI WAKTU (JAM,TANGGAL,DLL)</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="singel-pricing gray-bg text-center mt-30">
                        ...
                        <a href="#">DISINI GIFT (VIDEO BERPUTAR ITU ITU AJA)</a>
                    </div>
                </div>
            </div>
        </div>
