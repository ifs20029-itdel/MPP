<x-WebAdmin title="List Instansi">  
        ...
        <div class="toolbar d-flex align-items-stretch">
            ...
            <div
                ...
                <div class="page-title d-flex justify-content-center flex-column me-5">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Layanan Instasni</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">List Layanan Instansi</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="../../demo8/dist/apps/ecommerce/catalog/add-category.html"
                                class="btn btn-primary">Tambah Instansi</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px">Layanan Instansi</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <tr>
                                    ...
                                    <td>
                                        <!--begin::Badges-->
                                        <div class="badge badge-light-success">Link</div>
                                        <!--end::Badges-->
                                    </td>
                                    <td class="text-end">
                                        <a href="#"
