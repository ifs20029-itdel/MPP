            ...
            <div
                ...
                <div class="page-title d-flex justify-content-center flex-column me-5">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">List Berita</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{ route('backend.news.create') }}" class="btn btn-primary">Tambah Berita</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="news_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px">Judul Berita</th>
                                ...
                                @foreach ($news as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                    value={{ $item->id }} data-filter="news_id" />
                                            </div>
                                        </td>
                                        <!--end::Checkbox-->
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <!--begin::Thumbnail-->
                                                <a href="{{ route('backend.news.edit', $item->id) }}"
                                                    class="symbol symbol-50px">
                                                    <span class="symbol-label"
                                                        style="background-image:url('{{ asset('uploads/news/' . $item->image) }}')"></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="{{ route('backend.news.edit', $item->id) }}"
                                                        ...
                                                        data-filter="news_title">{{ $item->title }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
    ...
    @section('custom_js')
        <script>
            ...
            var News = function() {
                    ...
                    t.querySelectorAll('[data-filter="delete_row"]').forEach((t => {
                        t.addEventListener("click", (function(t) {
                            ...
                            const n = t.target.closest("tr"),
                                o = n.querySelector(
                                    '[data-filter="news_title"]').innerText,
                                i = n.querySelector(
                                    '[data-filter="news_id"]');
                            Swal.fire({
                ...
                return {
                    init: function() {
                        (t = document.querySelector("#news_table")) && ((e = $(t).DataTable({
                                info: !1,
                                order: [],
                                pageLength: 10,
                                columnDefs: [{
