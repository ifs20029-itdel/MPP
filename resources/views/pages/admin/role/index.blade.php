        ...
        <div class="toolbar d-flex align-items-stretch">
            ...
            <div
                ...
                <div class="page-title d-flex justify-content-center flex-column me-5">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Role</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">List Role</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{ route('backend.role.create') }}" class="btn btn-primary">Tambah
                                Role</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Card toolbar-->
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="role_table">
                            <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                    value={{ $item->id }} data-filter="role_id" />
                                            </div>
                                        </td>
                                        <!--end::Checkbox-->
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="{{ route('backend.role.edit', $item->id) }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                        data-filter="role_name">{{ $item->name }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
    ...
    @section('custom_js')
        <script>
            ...
            var Agency = function() {
                    ...
                    t.querySelectorAll('[data-filter="delete_row"]').forEach((t => {
                        t.addEventListener("click", (function(t) {
                            ...
                            const n = t.target.closest("tr"),
                                o = n.querySelector(
                                    '[data-filter="role_name"]').innerText,
                                i = n.querySelector(
                                    '[data-filter="role_id"]');
                            Swal.fire({
                ...
                return {
                    init: function() {
                        (t = document.querySelector("#role_table")) && ((e = $(t).DataTable({
                                info: !1,
                                order: [],
                                pageLength: 10,
                                columnDefs: [{
