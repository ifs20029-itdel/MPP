            ...
            <div
                ...
                <div class="page-title d-flex justify-content-center flex-column me-5">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Membuat User</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_input" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="{{ route('backend.user.index') }}" action="{{ route('backend.user.store') }}"
                    method="POST">
                    <!--begin::Main column-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="text-muted fs-7">
                                        Nama User yang akan ditampilkan di halaman utama.
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">
                                        Email User yang akan digunakan untuk login.
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">
                                        Role User yang akan digunakan untuk login.
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                <div class="mb-5 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">
                                        This is the password of the customer.
                                    </div>
                                    <!--end::Description-->
                                </div>
                            </div>
