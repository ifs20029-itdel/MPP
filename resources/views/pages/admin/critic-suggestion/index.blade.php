        ...
        <div class="toolbar d-flex align-items-stretch">
            ...
            <div
                ...
                <div class="page-title d-flex justify-content-center flex-column me-5">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Kritik & Saran</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Kritik & Saran</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">List Kritik & Saran</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="critic_table">
                            <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <!--begin::Title-->
                                                <span class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                    data-filter="critic_name">{{ $item->created_at }}</span>
                                                <!--end::Title-->
                                            </div>
                                        </td>
                                        <td class="text-end">
    ...
    @section('custom_js')
        <script>
            ...
            var Critics = function() {
                    ...
                    t.querySelectorAll('[data-filter="delete_row"]').forEach((t => {
                        t.addEventListener("click", (function(t) {
                            ...
                            const n = t.target.closest("tr"),
                                o = n.querySelector(
                                    '[data-filter="critic_name"]').innerText,
                                i = n.querySelector(
                                    '[data-filter="critic_id"]');
                            Swal.fire({
                ...
                return {
                    init: function() {
                        (t = document.querySelector("#critic_table")) && ((e = $(t).DataTable({
                                info: !1,
                                order: [],
                                pageLength: 10,
                                columnDefs: [{
